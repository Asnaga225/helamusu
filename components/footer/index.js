                    ...
                    <div className="row">
                        ...
                        {/* <div className="col col-lg-3 col-md-6 col-sm-12 col-12">
                            <div className="widget link-widget">
                                ...
                                <ul>
                                    <li><Link onClick={ClickHandler} href="/project">Our Projects</Link></li>
                                    <li><Link onClick={ClickHandler} href="/shop">Our Shop</Link></li>
                ...
                <div className="container">
                    <div className="row">
                        <div className="col col-xs-12">
                            <p className="copyright"> Copyright &copy; 2025 helamusu by <Link onClick={ClickHandler} href="/">AN solutions</Link>.
